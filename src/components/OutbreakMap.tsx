...
// Fix for default Leaflet icon issues in Next.js/Turbopack
    ...
    <div className="glass-panel p-8 bg-white/[0.02] border-white/5 rounded-[3rem] overflow-hidden">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h3 className="text-xl font-black uppercase tracking-tighter">
              Regional <span className="text-red-500">Outbreaks</span>
            </h3>
            <p className="text-[10px] font-bold text-gray-500 uppercase tracking-[0.3em]">
              Live Threat Mapping: Maharashtra
            </p>
          </div>
        </div>
      </div>

      {/* Explicit height container to prevent blank rendering */}
      <div className="h-[400px] w-full rounded-[2rem] overflow-hidden border border-white/5 relative z-0">
        <MapContainer
          ...
          zoom={8}
          style={{ height: "400px", width: "100%" }} // Fixed pixel height
              ...
              <Popup>
                <div className="text-black p-2 font-sans">
                  ...
                  <p className="text-[10px] mt-1 font-bold">
                    Risk Level:{" "}
                    <span style={{ color: spot.color }}>{spot.risk}</span>
                  </p>
                </div>
              </Popup>
            </Circle>
